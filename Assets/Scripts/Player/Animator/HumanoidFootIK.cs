...
namespace nickmaltbie.OpenKCC.Animation
{
    ...
    public class HumanoidFootIK : MonoBehaviour
    {
        ...
        void OnDrawGizmos()
        {
            ...
            // Left foot
            Vector3 src = animator.GetBoneTransform(HumanBodyBones.LeftLowerLeg).position;
            Gizmos.color = Color.green;
            Gizmos.DrawLine(src, src + Vector3.down * groundCheckDist);
        }
        /// <summary>
        ...
        {
            Debug.DrawLine(GetFootTransform(Foot.LeftFoot).position, LeftFootTarget.TargetFootPosition, Color.red);
            Debug.DrawLine(GetFootTransform(Foot.RightFoot).position, RightFootTarget.TargetFootPosition, Color.blue);
            UpdateFootTargets();
